...
<html lang="es">
  <head>
	...
	<body>
		...
		<p class="not-found">No<br/>Encontrada</p>
		<div class="clear"></div>
		<div class="content">
			Lo sentimos.La página no existe en nuestra web
			<br/><a href="index.php">Regresar</a> or<br/><form>Buscar<br/><input autofocus type="text" name="search" /></form>
		</div>
	</body>
</html>
